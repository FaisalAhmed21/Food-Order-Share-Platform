    ...
    <GoogleOAuthProvider clientId={process.env.REACT_APP_GOOGLE_CLIENT_ID || 'YOUR_GOOGLE_CLIENT_ID'}>
      <Router>
        <Routes>
          ...
          <Route path="/nearby-places" element={<ProtectedRoute allowedRoles={["Volunteer"]}><NearbyMap /></ProtectedRoute>} />
          <Route path="/my-assignments" element={<ProtectedRoute allowedRoles={["Volunteer"]}><MyAssignments /></ProtectedRoute>} />
