                    ...
                    <div className="place-info">
                      <h5>
                        ...
                        {restaurant.verificationMark && (
                          <span className="verified-badge" style={{marginLeft: '8px', background: '#10b981', color: 'white', padding: '2px 6px', borderRadius: '50%', fontSize: '12px'}} title="Verified Restaurant">✓</span>
                        )}
                      </h5>
