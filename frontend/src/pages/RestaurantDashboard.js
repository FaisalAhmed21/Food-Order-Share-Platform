            ...
            <div>
              <h1>
                ...
                {restaurant.verificationMark && (
                  <span className="verified-badge" style={{marginLeft: '8px', background: '#10b981', color: 'white', padding: '4px 8px', borderRadius: '50%', fontSize: '14px', fontWeight: 'bold'}} title="Verified Restaurant">✓</span>
                )}
              </h1>
